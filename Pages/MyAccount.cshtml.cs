...
namespace p2pRideshare.Pages
{
    public class MyAccountModel : PageModel
    {
        ...
        public MyAccountModel(IFileUploadService fileUploadService)
        {
        ...
        public void OnPostChangePassword()
        {
            ...
            try
            {
                ...
                Response.Redirect("/MyAccount?successMessage=" + successMessage + "&userId=" + user.userId);
                    ...
                    using (SqlCommand command = new SqlCommand(sql, connection))
                    {
                        ...
                        using (SqlDataReader reader = command.ExecuteReader())
                        {
                            while (reader.Read())
                            {
                                ...
                                user.subDueDate = reader.GetString(14);   
